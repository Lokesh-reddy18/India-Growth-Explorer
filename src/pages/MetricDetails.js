...
const MetricDetails = () => {
  ...
  if (!metric) return <div className="metricdetails-card">❌ Metric not found.</div>;
  ...
  return (
    <div className="metricdetails-card">
      <h2 className="metricdetails-title">{metric.title}</h2>
      <p className="metricdetails-desc">{metric.description}</p>
